...
while True:
    # load the winner
    try:
        with open('winner-{}-feedforward'.format(i), 'rb') as f:
            c = pickle.load(f)
...
# Run the given simulation for up to 120 seconds.
    ...
    print()
    print("Making movie...")
    make_movie(net, discrete_actuator_force, 30.0, "winner-{}-feedforward-movie.mp4".format(i))
    i += 5
...
print()
print("Making movie...")
make_movie(net, discrete_actuator_force, 30.0, "winner-feedforward-movie.mp4")
